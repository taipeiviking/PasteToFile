...
Write-Host "Registering COM server from $dstDll"
...
Write-Host "Dev-installed to $dstDir"
Write-Host "Debug log will be: $dstDir\\ptf-debug.log"
Write-Host "Restart Explorer to reload the DLL."
